            ...
            <div className="login-container">
                ...
                <form onSubmit={handleSubmit} noValidate autoComplete="off">
                    <div className="login-container-input-container">
                        <label for="username" className="login-container-desc">Username: </label>
                    ...
                    <div className="login-container-input-container">
                        <label for="email" className="login-container-desc" >Email: </label>
                    ...
                    <div className="login-container-input-container">
                        <label for="password" className="login-container-desc">Password: </label>
